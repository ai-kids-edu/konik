...
A world that makes kids say *wow* and is worth exploring: a **textured hero horse**, **real
animals** (no scaled-fox cheetah), **enterable buildings**, a **camera that never blinds you**,
...
|---|---|---|---|---|---|
| **Hero horse** | Toon Horse w/ Saddle — flairetic (Sketchfab) | CC-BY | Walk/Trot/Gallop | ✅ yes (5 skins) | the paintable horse; needs idle/eating/jump remap |
...
- **P2 — hero horse:** drop in the flairetic GLB (owner downloads from Sketchfab → `models/`), remap
  gaits, tune scale/rot, move mud/grooming to real UV textures now that the coat has UVs.
